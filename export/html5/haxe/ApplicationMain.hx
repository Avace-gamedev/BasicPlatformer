...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BasicPlatformer", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BasicPlatformer", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "BasicPlatformer";
		app.meta["name"] = "BasicPlatformer";
